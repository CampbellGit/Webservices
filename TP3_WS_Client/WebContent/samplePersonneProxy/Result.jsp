...
case 13:
        gotMethod = true;
        String taille_1id=  request.getParameter("taille16");
        int taille_1idTemp  = Integer.parseInt(taille_1id);
        int getPoids13mtemp = samplePersonneProxyid.getPoids(taille_1idTemp);
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(getPoids13mtemp));
        %>
        <%= tempResultreturnp14 %>
        <%
break;
