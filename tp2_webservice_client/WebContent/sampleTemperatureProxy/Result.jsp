...
case 13:
        ...
        double celsius_1idTemp  = Double.parseDouble(celsius_1id);
        double getFahrenheit13mtemp = sampleTemperatureProxyid.getFahrenheit(celsius_1idTemp);
        String tempResultreturnp14 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(getFahrenheit13mtemp));
        %>
        <%= tempResultreturnp14 %>
        <%
break;
case 18:
        ...
        double getCelsius18mtemp = sampleTemperatureProxyid.getCelsius(fahrenheit_2idTemp);
        String tempResultreturnp19 = org.eclipse.jst.ws.util.JspUtils.markup(String.valueOf(getCelsius18mtemp));
        %>
        <%= tempResultreturnp19 %>
        <%
break;
